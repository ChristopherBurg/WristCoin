...
//    scroll_layer_add_child(scroll_layer, text_layer_get_layer(exchange_name_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(low_label));
    ...
    low_text = text_layer_create((GRect) { .origin = { half_screen, 0 }, .size = { half_screen, 22 } });
...
//    layer_add_child(window_layer, text_layer_get_layer(low_text));
    scroll_layer_add_child(scroll_layer, text_layer_get_layer(low_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(high_label));
    ...
    high_text = text_layer_create((GRect) { .origin = { half_screen, 22 }, .size = { half_screen, 22 } });
...
//    layer_add_child(window_layer, text_layer_get_layer(high_text));
    scroll_layer_add_child(scroll_layer, text_layer_get_layer(high_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(last_label));
    ...
    last_text = text_layer_create((GRect) { .origin = { half_screen, 44 }, .size = { half_screen, 22 } });
...
//    layer_add_child(window_layer, text_layer_get_layer(last_text));
    scroll_layer_add_child(scroll_layer, text_layer_get_layer(last_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(average_label));
    ...
    average_text = text_layer_create((GRect) { .origin = { half_screen, 66 }, .size = { half_screen, 22 } });
...
//    layer_add_child(window_layer, text_layer_get_layer(average_text));
    scroll_layer_add_child(scroll_layer, text_layer_get_layer(average_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(buy_label));
    ...
    buy_text = text_layer_create((GRect) { .origin = { half_screen, 88 }, .size = { half_screen, 22 } });
...
//    layer_add_child(window_layer, text_layer_get_layer(buy_text));
    scroll_layer_add_child(scroll_layer, text_layer_get_layer(buy_text));
...
//    layer_add_child(window_layer, text_layer_get_layer(sell_label));
    ...
    sell_text = text_layer_create((GRect) { .origin = { half_screen, 110 }, .size = { half_screen, 22 } });
