...
static void draw_row_callback(GContext* ctx, Layer *cell_layer, MenuIndex *cell_index, void *data) {
    ...
    int32_t characteristic, mantissa;
    ...
    */ 
    ...
    default:
        ...
        */
        characteristic = exchange_data->last / 100;
        mantissa = exchange_data->last - (characteristic * 100);
        snprintf(last, PRICE_FIELD_LENGTH, "$ %ld.%02ld", characteristic, mantissa); 
    }
